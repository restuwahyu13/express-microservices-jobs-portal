...
export const initDeleteJobsPostCompaniesSubscriber = async (): Promise<void> => {
	const deleteCompaniesJobsSubscriber = new Subscriber({ key: 'Delete Jobs Post Companies' })
	const res: ICompanies = await deleteCompaniesJobsSubscriber.getMap('companies:jobs:delete:service')
