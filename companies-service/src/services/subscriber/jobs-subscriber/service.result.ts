...
export const initResultJobsPostCompaniesSubscriber = async (): Promise<void> => {
	const resultCompaniesJobsSubscriber = new Subscriber({ key: 'Result Jobs Post Companies' })
	const res: ICompanies = await resultCompaniesJobsSubscriber.getMap('companies:jobs:result:service')
