...
router.delete('/users/:userId/profile/appreciation/:appreciationId', controller.appreciationsDeleteController)
...
router.put('/users/:userId/profile/appreciation/:appreciationId', controller.appreciationsUpdateController)
